...
// les options pour créer le serveur
const options = {
  key: fs.readFileSync('server/ssl/key.pem'),
  passphrase:process.env.KEY_PASSWORD, //mot de passe de la clé dans une variable environnement
  cert: fs.readFileSync('server/ssl/signed_certificate.pem'),
  ca: fs.readFileSync('certificat/autorite.pem'),
  requestCert: true, // demande un certificat client
  ciphers: 'TLS_AES_128_GCM_SHA256:TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-GCM-SHA384:', // liste de jeux de chiffrements accepté par le serveur
  isServer: true,
};
// création du serveur avec les options 
...
server.on('secureConnection', (socket) => {
  // si le client a un certificat qui est valide, on tombe en connection sécurisé
